...
geom = np.array([src_x, src_z, rec2_x, rec2_z, rec21_x, rec21_z, 
...
np.save('model_Sinu_t_topo', model_topo)
np.save('model_Sinu_t', model)
OUT_dataframe.to_pickle('data_3D_Sinusoidal_topo.pkl')
