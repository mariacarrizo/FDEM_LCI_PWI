...
print('Using files:')
print('models/model_d'+sl+'_c'+co+'_u'+cr+'.npy')
print('data/data_d'+sl+'_c'+co+'_u'+cr+'_nosort.npy')
print()

# Load true models

# model parameters [h_1, sigma_1, sigma_2]
model_true = np.load('models/model_d'+sl+'_c'+co+'_u'+cr+'.npy')
...
data_true = np.load('data/data_d'+sl+'_c'+co+'_u'+cr+'_nosort.npy')
...
np.save('results/model_inv_d'+sl+'_c'+co+'_u'+cr+'_nosort_lam1', model_inv)
np.save('results/data_inv_d'+sl+'_c'+co+'_u'+cr+'_nosort_lam1', data_inv)

print()
print('saved model in as model_inv_d'+sl+'_c'+co+'_u'+cr+'_nosort_lam1')
print('saved data as data_inv_d'+sl+'_c'+co+'_u'+cr+'_nosort_lam1')
