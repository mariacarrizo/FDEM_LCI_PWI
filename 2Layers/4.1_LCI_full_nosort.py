...
model_inv = inv.run(data_true_vector, relativeError, startModel=model_ini.ravel(), verbose=False, lam=0 )
...
np.save('results/model_inv_s'+sl+'_c'+co+'_u'+cr+'_nosort', model_inv)
np.save('results/data_inv_s'+sl+'_c'+co+'_u'+cr+'_nosort', data_inv)

print()
print('saved model in as model_inv_s'+sl+'_c'+co+'_u'+cr+'_nosort')
print('saved data as data_inv_s'+sl+'_c'+co+'_u'+cr+'_nosort')