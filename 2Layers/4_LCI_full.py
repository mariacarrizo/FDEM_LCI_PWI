...
np.save('results/model_inv_s'+sl+'_c'+co+'_u'+cr, model_inv)
np.save('results/data_inv_s'+sl+'_c'+co+'_u'+cr, data_inv)

print()
print('saved model in as model_inv_s'+sl+'_c'+co+'_u'+cr)
print('saved data as data_inv_s'+sl+'_c'+co+'_u'+cr)