...
LCI.normalization(data_true, cWeight_1=1, cWeight_2=2, nLay=nLayers)
LCI.createWeight(data_true, cWeight_1=1, cWeight_2=2, nLay=nLayers)
...
np.save('results/model_inv_s'+sl+'_c'+co+'_u'+cr+'_lam1', model_inv)
np.save('results/data_inv_s'+sl+'_c'+co+'_u'+cr+'_lam1', data_inv)

print()
print('saved model in as model_inv_s'+sl+'_c'+co+'_u'+cr+'_lam1')
print('saved data as data_inv_s'+sl+'_c'+co+'_u'+cr+'_lam1')