...
def Plot2Datas(data_1D, data_3D):
    ...
    ax[0,1].plot(100*np.abs((data_1D[:,0]-data_3D[:,0])/data_1D[:,0]), ':b', label='H2 Q')
    ax[0,1].plot(100*np.abs((data_1D[:,3]-data_3D[:,3])/data_1D[:,3]), ':r', label='P2 Q')
    ax[0,1].plot(100*np.abs((data_1D[:,6]-data_3D[:,6])/data_1D[:,6]), ':k', label='V2 Q')
    ...
    ax[1,1].plot(100*np.abs((data_1D[:,1]-data_3D[:,1])/data_1D[:,1]), ':b', label='H4 Q')
    ax[1,1].plot(100*np.abs((data_1D[:,4]-data_3D[:,4])/data_1D[:,4]), ':r', label='P4 Q')
    ax[1,1].plot(100*np.abs((data_1D[:,7]-data_3D[:,7])/data_1D[:,7]), ':k', label='V4 Q')
    ...
    ax[2,1].plot(100*np.abs((data_1D[:,2]-data_3D[:,2])/data_1D[:,2]), ':b', label='H8 Q')
    ax[2,1].plot(100*np.abs((data_1D[:,5]-data_3D[:,5])/data_1D[:,5]), ':r', label='P8 Q')
    ax[2,1].plot(100*np.abs((data_1D[:,8]-data_3D[:,8])/data_1D[:,8]), ':k', label='V8 Q')
    ...
    ax[0,3].plot(100*np.abs((data_1D[:,9]-data_3D[:,9])/data_1D[:,9]), ':b', label = 'H2 IP')
    ax[0,3].plot(100*np.abs((data_1D[:,12]-data_3D[:,12])/data_1D[:,12]), ':r', label = 'P2 IP')
    ax[0,3].plot(100*np.abs((data_1D[:,15]-data_3D[:,15])/data_1D[:,15]), ':k', label='V2 IP')
    ...
    ax[1,3].plot(100*np.abs((data_1D[:,10]-data_3D[:,10])/data_1D[:,10]), ':b', label = 'H4 IP')
    ax[1,3].plot(100*np.abs((data_1D[:,13]-data_3D[:,13])/data_1D[:,13]), ':r', label = 'P4 IP')
    ax[1,3].plot(100*np.abs((data_1D[:,16]-data_3D[:,16])/data_1D[:,16]), ':k', label='V4 IP')
    ...
    ax[2,3].plot(100*np.abs((data_1D[:,11]-data_3D[:,11])/data_1D[:,11]), ':b', label = 'H8 IP')
    ax[2,3].plot(100*np.abs((data_1D[:,14]-data_3D[:,14])/data_1D[:,14]), ':r', label = 'P8 IP')
    ax[2,3].plot(100*np.abs((data_1D[:,17]-data_3D[:,17])/data_1D[:,17]), ':k', label='V8 IP')
